...
(function(){
	...
	timetable.addEvent('Candi Station', 'Maas Room', new Date(2015, 7, 17, 20, 0), new Date(2015, 7, 17, 20, 30));
	timetable.addEvent('Gregory Porter', 'Maas Room', new Date(2015, 7, 17, 20, 35), new Date(2015, 7, 18, 0, 30));
